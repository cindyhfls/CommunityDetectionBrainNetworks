function Draw_ROIs_Through_Cortex_HSB(Anat,ROI,Conn,params)
%
...
%% Draw cortex
if params.brain
Image_Mesh_Data_2hem_HSB(Anat.CtxL,Anat.CtxR,params,Anat.view,Anat.ctx,...
    params.fig);
colorbar off
end
hold on
...
ends=AdjustFoci_HSB(ends,Anat.CtxL,Anat.CtxR,Anat.view,Anat.ctx);
...
foci=AdjustFoci_HSB(foci,Anat.CtxL,Anat.CtxR,Anat.view,Anat.ctx);
hold on
Draw_Foci_HSB(foci,10)
