function Image_Mesh_Data_2hem_HSB(meshL,meshR,params,side,ctx,fig)
...
[Rnodes,Lnodes]=Adjust_Brain_Pos_for_Vis_HSB(meshL,meshR,params,side,ctx);
...
% Image Left
dataL=CMapMix2_HSB(meshL.data,params);
FaceColor='interp';
...
% Image Right
dataR=CMapMix2_HSB(meshR.data,params);
FaceColor='interp';
