...
cd(path_to_code); addpath(genpath(path_to_code));
% global infomappath
%% Load parameters

params = get_params_mat_eLABE_Y2_N92_healthyterm(fullfile(path_to_code,'/ExternalFunctions/infomap/Infomap'));

%% Wrapper to Infomap

stats=GraphCluster_HSB(params.zmat,params); % this can take 10-20 minutes depending on your data/server specs
