function [M,Q,Q_M0]=community_louvain(W,gamma,M0,B)
...
%   2022: Don't produce error when there's negative weights but custom B
%   Jiaxin Cindy Tu
%   2022: Return modularity for M0. Jiaxin Cindy Tu
...
elseif min(min(W))<-1e-10 && ischar(type_B)
    err_string = [
